...
{
    protected $table      = 'media_lesson';
    protected $primaryKey = 'media_lesson_id';
    ...
    protected $allowedFields = ['file_name', 'lesson_content_id','file_targetDirectory','file_extension'];
