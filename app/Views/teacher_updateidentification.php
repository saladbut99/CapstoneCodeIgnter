...
<center>
    ...
    <div id='border' style="border:1px solid white; width:70%; margin-bottom:5%; border-radius:10px;">
     <form class="" action="<?php echo site_url('teacher/update_identification/'.$activity->activity_content_id);?>" method="post" id="form" style="display:block; margin-bottom:5%;"  enctype="multipart/form-data">
      <div class="container">
        <div class="row">
          <div class="col">
      ...
      <div class="container">
        <div class="row">
          <div class="col">
            <h1 style="margin-bottom:5%;">Update Question</h1>
          </div>
        </div>
      </div>
         ...
         <div class="row">
           <div class="col-sm">
                   <div class="form-group">
                     ...
                     <textarea class="form-control" style="width: 80%; border: 2px solid #00acee;" id="exampleFormControlTextarea1" placeholder="" rows="4" name="activity_question" required><?= $activity->activity_question ?></textarea>
                   </div>
       ...
       <div style="width:90%;">
         ...
         <div class="form-check grupouno">
           ...
           <label class="form-check-label" for="flexRadioDefault1" >
               <input type="text" id="question_4" class="form-control input-mc" name="activity_answer" style="border-color: #00acee; border-width: 2px; border-radius:15px; height: 50px;" value="<?= $activity->activity_answer; ?>" required>
           </label>
         </div>
         <div class="text-danger" style="margin-top:3%;">
           <?php if (isset($validation)): ?>
                 <?php if ($validation->hasError('activity_answer')): ?>
                       <p>  <?= $validation->getError('activity_answer') ?></p>
                 <?php endif; ?>
           <?php endif; ?>
         </div>
       </div>
