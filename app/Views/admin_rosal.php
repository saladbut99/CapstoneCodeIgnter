...
<div class="navbar" style="background: linear-gradient(rgba(0, 0, 0, 0.4), rgba(0, 0, 0, 0.4)),url(<?=base_url()?>/public/assets/images/banner.png);">
   ...
   <?php $fname; $lname?>
       ...
       <h1 style="text-align:center; font-size:500%;"><b>Grade 1 Rosal</b></h1>
       <?php if ($teachers): ?>
          <?php foreach ($teachers as $teacher): ?>
            <?php if ($teacher['section_id']==2 && strcmp(strtoupper($teacher['account_status']),strtoupper('active'))==0): ?>
           ...
           <table class="table table-borderless table-hover" id="users-list"  style=" border-bottom: none;">
             <thead style="text-align:left; font-size:3rem">
                ...
                <?php foreach($users as $user): ?>
                  <?php if ($user['section_id']==2 && strcmp(strtoupper($user['status']),strtoupper('published'))==0): ?>
                    <tr>
