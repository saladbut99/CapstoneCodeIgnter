  ...
  <div class="container h-100" style="margin-bottom:5%;" id="wrapper" >
     <div class="row">
       <div class="backbutton col-2">
           <a  style="cursor: pointer; text-decoration: none; color: rgb(68, 68, 68);" onclick = "history.back()">
...
<div class="container">
  ...
  <table class="table table-bordered display nowrap" id="users-list"  cellspacing="0" style="width:100%; margin-bottom:5%;" >
