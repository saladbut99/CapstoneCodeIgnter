...
<center>
  ...
  <div class="container h-100" style="margin-bottom:0%;" id="wrapper" >
     <div class="row">
       <div class="backbutton d-flex align-items-center py-2" style="background-color:teal; width: 12%; height: fit-content; border: 1px solid black; border-radius: 20px; border-right: none;">
           <a href="<?php echo base_url(); ?>/public/pupil/viewactivitytable/<?= $id->lesson_id; ?>" style="text-decoration: none; color: rgb(68, 68, 68); cursor:pointer;">
...
<div class="container" style="margin-bottom:5%;">
    <div class="row">
      <div class="col">
        <h1>Hi <?= session()->get('firstname') ?>! Here are your activity results for </h1>
