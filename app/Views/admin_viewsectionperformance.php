      ...
      <div class="container  h-100 ">
        <div class="row h-100 align-items-center ">
            <div class="col text-center" >
                ...
                <a href="viewpupil_section\<?= $section='rose'; ?>" class=" btn btn-light btn-outline-primary" style="margin-top: 5%; margin-bottom: 5%;"> View Module</a>
                </div>
            </div>
            <div class="col text-center" >
                ...
                <br>
                <h3 style="color:white;">Grade 1</h3>
                <a href="viewpupil_section\<?= $section='rosal'; ?>" class=" btn btn-light btn-outline-primary" style="margin-top: 5%; margin-bottom: 5%;"> View Module</a>
                </div>
            </div>
            <div class="col text-center" >
                ...
                <br>
                <h3 style="color:white;">Grade 1</h3>
                <a href="viewpupil_section\<?= $section='adelfa'; ?>" class=" btn btn-light btn-outline-primary" style="margin-top: 5%; margin-bottom: 5%;"> View Module</a>
                </div>
            </div>
            <div class="col text-center" >
                ...
                <a href="viewpupil_section\<?= $section='lily'; ?>" class=" btn btn-light btn-outline-primary" style="margin-top: 5%; margin-bottom: 5%;"> View Module</a>
                </div>
            </div>
        </div>
      </div>
      ...
      <div class="container  h-100 ">
        <div class="row h-100 align-items-center ">
            <div class="col-3 text-center" >
                ...
                <br>
                <h3 style="color:white;">Grade 2</h3>
                <a href="viewpupil_section\<?= $section='gumamela'; ?>" class=" btn btn-light btn-outline-primary" style="margin-top: 5%; margin-bottom: 5%;"> View Module</a>
                </div>
            </div>
            <div class="col-3 text-center" >
                ...
                <br>
                <h3 style="color:white;">Grade 2</h3>
                <a href="viewpupil_section\<?= $section='orchid'; ?>" class=" btn btn-light btn-outline-primary" style="margin-top: 5%; margin-bottom: 5%;"> View Module</a>
                </div>
            </div>
            <div class="col-3 text-center" >
                ...
                <br>
                <h3 style="color:white;">Grade 2</h3>
                <a href="viewpupil_section\<?= $section='daisy'; ?>" class=" btn btn-light btn-outline-primary" style="margin-top: 5%; margin-bottom: 5%;"> View Module</a>
                </div>
            </div>
        </div>
      </div>
