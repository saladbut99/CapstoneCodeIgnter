        ...
        <div class="row h-100 align-items-center ">
            ...
            <div class="col-md text-center">
                <div class="dashboard_div section">
                    ...
                    <a href="viewsection" class=" btn btn-light btn-outline-primary" style="margin-top: 10%; margin-bottom: 10%;"> View Lesson</a>
                    </div>
            </div>
            ...
            <div class="col-md text-center">
                ...
                <a href="viewperformance_section" class=" btn btn-light btn-outline-primary" style="margin-top: 10%; margin-bottom: 10%;"> View Performance</a>
                </div>
            </div>
        </div>
      </div>
