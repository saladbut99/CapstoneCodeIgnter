   ...
   <?php $fname; $lname?>
       ...
       <?php if ($teachers): ?>
          <?php foreach ($teachers as $teacher): ?>
            <?php if ($teacher['section_id']==3 && strcmp(strtoupper($teacher['account_status']),strtoupper('active'))==0): ?>
           ...
           <table class="table table-borderless table-hover" id="users-list"  style=" border-bottom: none;">
             <thead style="text-align:left; font-size:3rem">
                ...
                <?php foreach($users as $user): ?>
                  <?php if ($user['section_id']==3 && strcmp(strtoupper($user['status']),strtoupper('published'))==0): ?>
                    <tr>
