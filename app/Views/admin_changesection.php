          ...
          <div class="col-12 col-md-9 col-lg-7 col-xl-6">
            <div class="card" style="border-radius: 15px; border:3px solid #00acee;width:100%;">
              <div class="card-body p-5 row">
                ...
                <h2 class="text-uppercase text-center mb-5 col-10">Chang Teacher Section</h2>
                <h3 style="text-align:center;">Current Section: <?= $user_section->section_name ?></h3>
              ...
              <br>
                <form method="post" action="<?php echo site_url('admin/changesection/'.$user->teacher_id);?>">
                  ...
                  <?php $i=1; foreach ($section as $sec): ?>
                    <?php if (strcmp($sec,$user_section->section_name)==0): ?>
                      <option  value="<?= $i; $i++;?>" selected><?= $sec ?></option>
                    <?php else: ?>
