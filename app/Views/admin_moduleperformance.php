...
<?php $fname; $lname; $section_name;?>
       ...
       <?php endif; ?>
         <h3 class=" text-center">Please select a module to view <?= $pupil->pupil_firstname ?> <?= $pupil->pupil_lastname?>'s activity results, </h3>
          <h3 class=" text-center">or view module overall performance. </h3>
