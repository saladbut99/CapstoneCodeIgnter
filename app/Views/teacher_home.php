        ...
        <div class="row h-100 align-items-center ">
            <div class="col-md text-center" >
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="green" class="bi bi-person-plus" viewBox="0 0 16 16">
                  ...
                  <br><br>
                  <p>Register a Student Account.</p>
                <a href="register" class=" btn btn-light btn-outline-primary" style="margin-top: 10%; margin-bottom: 10%;"> Register Account</a>
                </div>
            </div>
            ...
            <div class="col-md text-center">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="green" class="bi bi-person-check" viewBox="0 0 16 16">
                  ...
                  <br><br>
                  <p>Manage Account or Change Pupil Account Status.</p>
                <a href="manageaccount" class=" btn btn-light btn-outline-primary" style="margin-top: 10%; margin-bottom: 10%;"> Change Account Status</a>
                </div>
            </div>
