              ...
              <div class="col-12 col-md-9 col-lg-7 col-xl-6">
                <div class="card" style="border-radius: 15px; border:3px solid #00acee;width:100%;">
                  <div class="card-body p-5 row">
                    ...
                    <br><br>
                    <a href="register" class="check card-link"><svg style="border:2px solid green; border-radius: 100px;" xmlns="http://www.w3.org/2000/svg" width="100" height="100" fill="green" class="bi bi-check-lg" viewBox="0 0 16 16">
