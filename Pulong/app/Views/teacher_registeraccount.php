...
<body>
 <div class="navbar">
        <nav class="nav row w-100 align-items-center">
            <div class="col-10">
                <a href="#" style="text-decoration: none;"><h1 style="color: black;" onclick="index.html"><b>Pulong</b></h1></a>
            </div>
            ...
            <div class="col-1 text-center">
                <div>
                    <a href=""><img src="website/admin.png" alt="" class="nav_img" height="60" width="60"></a>
                </div>
            </div>
        </nav>
    </div>
                ...
                <div class="card" style="border-radius: 15px; border:3px solid #00acee;width:100%;">
                  <div class="card-body p-5 row">
                    ...
                    <div class="backbutton col-2">
                        <a href="admin_home.html" style="text-decoration: none; color: rgb(68, 68, 68);">
                    ...
                    <form>
                      ...
                      <div class="form-outline mb-4 row align-items-center">
                        ...
                        <input type="text" id="middlename" class="form-control form-control-lg col" />
                      ...
                      <div class="form-outline mb-4 row align-items-center">
                        <label class="form-label col-4 p-0" for="form3Example4cg">ADDRESS</label>
                        <input type="text" id="address" class="form-control form-control-lg col" />
                      ...
                      <div class="form-outline mb-4 row align-items-center">
                        ...
                        <input type="text" id="fathername" class="form-control form-control-lg col" />

                      </div>
                      
                      <div class="form-outline mb-4 row align-items-center">
                        <label class="form-label col-4 p-0" for="form3Example1cg">MOTHER FULL NAME</label>
                        <input type="text" id="mothername" class="form-control form-control-lg col" />

                      </div>

                      <div class="form-outline mb-4 row align-items-center">
                        <label class="form-label col-4 p-0" for="form3Example1cg">GUARDIAN FULL NAME</label>
                        <input type="text" id="guardianname" class="form-control form-control-lg col" />
